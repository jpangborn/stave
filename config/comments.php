...
return [
    ...
    "actions" => [
        ...
        "send_notifications_for_pending_comment" =>
            SendNotificationsForPendingCommentAction::class,
        "approve_comment" => ApproveCommentAction::class,
        "reject_comment" => RejectCommentAction::class,
        "resolve_mentions_autocomplete" =>
            ResolveMentionsAutocompleteAction::class,
        "send_notifications_for_approved_comment" =>
