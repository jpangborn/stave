...
<flux:table.row>
    <flux:table.cell>
        <flux:link variant="subtle" href="{{ route('songs.show', ['song' => $song]) }}" >{{ $song->name }}</flux:link>
    </flux:table.cell>
    <flux:table.cell>
        @if($song->ccli_number)
    ...
    <flux:table.cell align="end">
        <flux:dropdown align="end" offset="-15">
            ...
            <flux:menu class="min-w-32">
                <flux:menu.item href="{{ route('songs.edit', ['song' => $song]) }}" icon="pencil-square">Edit</flux:menu.item>
