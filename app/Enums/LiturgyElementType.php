...
enum LiturgyElementType: string
{
    ...
    {
        return match ($this) {
            self::SECTION => "elements.section",
            self::SONG => "elements.song",
            self::READING => "elements.reading",
            self::SERMON => "elements.sermon",
            self::PRAYER => "elements.reading",
            self::SUPPER => "elements.other",
            self::BAPTISM => "elements.other",
